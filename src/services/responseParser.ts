...
export class ResponseParser {
    parseCompletion(rawCompletion: string, context: CodeContext): string {
        if (!rawCompletion) {
            return '';
        }
    ...
    private cleanExplanations(text: string): string {
    ...
    private truncateCompletion(completion: string, context: CodeContext): string {
    ...
    private isNaturalStoppingPoint(line: string, language: string): boolean {
    ...
    private adjustIndentation(completion: string, context: CodeContext): string {
